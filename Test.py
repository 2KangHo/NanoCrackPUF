...
def Test():
    ...
    cor1 = np.correlate(slopes1, slopes2, mode='full')
    cor2 = np.correlate(slopes2, slopes2_1, mode='full')
    cor3 = np.correlate(slopes1, slopes3, mode='full')
    cor4 = np.correlate(slopes3, slopes4, mode='full')
